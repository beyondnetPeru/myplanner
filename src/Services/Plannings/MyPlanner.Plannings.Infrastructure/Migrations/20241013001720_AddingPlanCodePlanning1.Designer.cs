...
namespace MyPlanner.Plannings.Infrastructure.Migrations
{
    ...
    [Migration("20241013001720_AddingPlanCodePlanning1")]
    partial class AddingPlanCodePlanning1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyPlanner.Plannings.Infrastructure.Database.Tables.PlanCategoryTable", b =>
                {
                    ...
                    b.ToTable("plancategories", "myplanner-plannings");
                });
            ...
            modelBuilder.Entity("MyPlanner.Plannings.Infrastructure.Database.Tables.PlanItemTable", b =>
                {
                    ...
                    b.Property<int>("BusinessFeatureComplexityLevel")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("BusinessFeatureMoScoW")
                        .HasColumnType("int");
