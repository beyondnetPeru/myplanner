namespace MyPlanner.Plannings.Domain.PlanAggregate
{
    public class PlanItemProps : IProps
    {
        ...
        public PlanItemTypeEnum PlanItemType { get; set; }
    ...
    public class PlanItem : Entity<PlanItem, PlanItemProps>
    {
        ...
        public static PlanItem Load(string id, 
                             int planItemType, 
                             string planId, 
                             string productId, 
                             ...
                             string userId)
        {
            return new PlanItem(new PlanItemProps(IdValueObject.Create(id),
                Enumeration.FromValue<PlanItemTypeEnum>(planItemType)!,
        ...
        public void ChangePlanItemType(PlanItemTypeEnum planItemType, UserId userId)
        {
            Props.PlanItemType = planItemType;
