...
{
    public class ChangeFactorSizeModelItemRequestHandler : AbstractCommandHandler<ChangeFactorSizeModelItemRequest, ResultSet>
    {
        ...
        public override async Task<ResultSet> HandleCommand(ChangeFactorSizeModelItemRequest request, CancellationToken cancellationToken)
        {
